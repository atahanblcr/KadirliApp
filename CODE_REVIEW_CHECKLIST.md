...
> `Memory_Bank/Active_Context.md` ve `Memory_Bank/Progress.md`'den (Faz 10–12.4) çıkarılmıştır.
...
Son gözden geçirme: **9 Ağustos 2026 (Faz 12.4)** — §11'e dört satır (liste/detay
