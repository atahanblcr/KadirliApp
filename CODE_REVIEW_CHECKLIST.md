...
> `Memory_Bank/Active_Context.md` ve `Memory_Bank/Progress.md`'den (Faz 10–12.5) çıkarılmıştır.
...
Son gözden geçirme: **10 Ağustos 2026 (Faz 12.6)** — §5'e dört satır: additive bir alanın
