...
mixin _$CurrentUser {
 ...
 String? get profilePhotoUrl; DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,phone,username,email,age,role,primaryNeighborhoodId,primaryNeighborhoodName,profilePhotoUrl,createdAt);

@override
String toString() {
  return 'CurrentUser(id: $id, phone: $phone, username: $username, email: $email, age: $age, role: $role, primaryNeighborhoodId: $primaryNeighborhoodId, primaryNeighborhoodName: $primaryNeighborhoodName, profilePhotoUrl: $profilePhotoUrl, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String phone, String? username, String? email, int? age, String role, String? primaryNeighborhoodId, String? primaryNeighborhoodName, String? profilePhotoUrl, DateTime? createdAt
});
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? phone = null,Object? username = freezed,Object? email = freezed,Object? age = freezed,Object? role = null,Object? primaryNeighborhoodId = freezed,Object? primaryNeighborhoodName = freezed,Object? profilePhotoUrl = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String phone,  String? username,  String? email,  int? age,  String role,  String? primaryNeighborhoodId,  String? primaryNeighborhoodName,  String? profilePhotoUrl,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CurrentUser() when $default != null:
return $default(_that.id,_that.phone,_that.username,_that.email,_that.age,_that.role,_that.primaryNeighborhoodId,_that.primaryNeighborhoodName,_that.profilePhotoUrl,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String phone,  String? username,  String? email,  int? age,  String role,  String? primaryNeighborhoodId,  String? primaryNeighborhoodName,  String? profilePhotoUrl,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _CurrentUser():
return $default(_that.id,_that.phone,_that.username,_that.email,_that.age,_that.role,_that.primaryNeighborhoodId,_that.primaryNeighborhoodName,_that.profilePhotoUrl,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String phone,  String? username,  String? email,  int? age,  String role,  String? primaryNeighborhoodId,  String? primaryNeighborhoodName,  String? profilePhotoUrl,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _CurrentUser() when $default != null:
return $default(_that.id,_that.phone,_that.username,_that.email,_that.age,_that.role,_that.primaryNeighborhoodId,_that.primaryNeighborhoodName,_that.profilePhotoUrl,_that.createdAt);case _:
  return null;
...
class _CurrentUser extends CurrentUser {
  const _CurrentUser({required this.id, required this.phone, this.username, this.email, this.age, this.role = 'user', this.primaryNeighborhoodId, this.primaryNeighborhoodName, this.profilePhotoUrl, this.createdAt}): super._();
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? phone = null,Object? username = freezed,Object? email = freezed,Object? age = freezed,Object? role = null,Object? primaryNeighborhoodId = freezed,Object? primaryNeighborhoodName = freezed,Object? profilePhotoUrl = freezed,Object? createdAt = freezed,}) {
