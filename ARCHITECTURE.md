...
| 27 | **Haberler** | `News/` (+`WordPressTimeWindow` · `NewsImagePicker` · `NewsHtmlPolicy` · `NewsVisibility` · `NewsProjection` · `Services/NewsSyncService`) | `news`, `news/{id}`, `news/categories` | *(12.13'te — `NewsAdmin`)* | `news` | *(12.14'te)* | *(12.14'te)* |
...
Koda bakarak anlaşılmayan, bozulunca **sessizce** hasar veren bağımlılıklar (**57 madde**). Hepsi
